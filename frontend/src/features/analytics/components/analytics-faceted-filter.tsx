      ...
      <PopoverContent className='w-[200px] p-0' align='start'>
        <Command shouldFilter={!onSearchChange}>
          <div className='relative'>
            ...
            {isFetching && <IconLoader2 className='text-muted-foreground absolute top-3 right-3 size-4 animate-spin' />}
          </div>
          <CommandList>
            {isError ? (
              <div className='text-muted-foreground flex flex-col items-center gap-2 px-2 py-4 text-center text-xs'>
