                  ...
                  <FormItem>
                    ...
                    <Select value={field.value} onValueChange={field.onChange}>
                      ...
                      <SelectContent>
                        ...
                        <SelectItem value='0' disabled={form.watch('maxUses') === '0'}>{t('users.invitation.expiry.never')}</SelectItem>
                      </SelectContent>
                    </Select>
                    <FormMessage />
                  </FormItem>
                  ...
                  <FormItem>
                    ...
                    <Select value={field.value} onValueChange={field.onChange}>
                      ...
                      <SelectContent>
                        ...
                        <SelectItem value='0' disabled={form.watch('expiresInHours') === '0'}>{t('users.invitation.uses.unlimited')}</SelectItem>
                      </SelectContent>
                    </Select>
                    <FormMessage />
                  </FormItem>
