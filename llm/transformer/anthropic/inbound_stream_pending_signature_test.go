...
func TestPendingSignature_InterleavedResponsesReasoningSummariesPreserveItemOrder(t *testing.T) {
	responses := []*llm.Response{
		buildChunk("msg_interleaved_reverse", "gpt-5", withReasoningContentForItem("first", "rs_first")),
		buildChunk("msg_interleaved_reverse", "gpt-5", withReasoningContentForItem("second", "rs_second")),
		buildChunk("msg_interleaved_reverse", "gpt-5", withReasoningSignatureForItem("gAAAA_SECOND_BLOB", "rs_second")),
		buildChunk("msg_interleaved_reverse", "gpt-5", withReasoningSignatureForItem("gAAAA_FIRST_BLOB", "rs_first")),
		buildChunk("msg_interleaved_reverse", "gpt-5", withFinishReason("tool_calls")),
	}
