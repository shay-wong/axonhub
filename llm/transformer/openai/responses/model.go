...
type Item struct {
	...
	// "function_call", "function_call_output", "custom_tool_call", "custom_tool_call_output", "image_generation_call",
	// "web_search_call", "tool_search_call", "tool_search_output", "reasoning", "reasoning_text".
	Type string `json:"type,omitempty"`
