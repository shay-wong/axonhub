...
func (_m *UsageLog) Node(ctx context.Context) (node *Node, err error) {
	...
	if buf, err = json.Marshal(_m.AppliedServiceTier); err != nil {
		return nil, err
	}
	node.Fields[23] = &Field{
		Type:  "string",
		Name:  "applied_service_tier",
		Value: string(buf),
	}
	if buf, err = json.Marshal(_m.ServiceTier); err != nil {
		return nil, err
	}
	node.Fields[24] = &Field{
		Type:  "string",
