...
func TestCompareVersions(t *testing.T) {
	tests := []struct {
		...
		{name: "fork follows upstream stable", a: "v1.0.0-fork.1", b: "v1.0.0", want: 1},
		{name: "fork follows upstream beta", a: "v1.0.0-beta10-fork.1", b: "v1.0.0-beta10", want: 1},
		{name: "fork counters compare numerically", a: "v1.0.0-beta10-fork.10", b: "v1.0.0-beta10-fork.9", want: 1},
		{name: "fork base counters compare numerically", a: "v1.0.0-beta10-fork.1", b: "v1.0.0-beta9-fork.10", want: 1},
		{name: "fork dotted and glued bases are equivalent", a: "v1.0.0-beta.10-fork.1", b: "v1.0.0-beta10-fork.1", want: 0},
	}
